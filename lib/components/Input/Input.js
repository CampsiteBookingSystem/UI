...
function Input(props) {
    ...
    const [errorContainerHeight, setErrorContainerHeight] = React.useState(0);
    const errorContainer = React.useRef();
    React.useEffect(() => {
    ...
    return (React.createElement("div", { className: classes, style: { paddingBottom: hasError ? `${errorContainerHeight + 4}px` : 0 } },
        React.createElement("label", { className: "BS-Input__input-container", htmlFor: props.id },
            ...
            props.type === 'password' && (React.createElement("button", { type: "button", className: "BS-Input__action BS-Input__action--password", onClick: handlePasswordVisibilityClick },
                React.createElement(Eye, null))),
            props.type !== 'password' && props.canClear && (React.createElement("button", { type: "button", className: "BS-Input__action BS-Input__action--clear", onClick: handleClearClick },
                React.createElement(Clear, null)))),
        React.createElement("div", { ref: errorContainer, className: "BS-Input__error-container" },
